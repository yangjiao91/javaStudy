...
<div class="bjui-pageContent">
	<form action="${ctx}/topic/edit" method="post" data-toggle="validate" data-alertmsg="false">
		<!-- hidden fields -->
		<input id="hasTail" name="hasTail" type="hidden"  value="${topic.hasTail}">
		<input id="topicId" name="topicId" type="hidden"  value="${topic.id}">
		<input id="schemaId" name="schemaId" type="hidden"  value="${schema.id}">
